export default {
  ...
  'suggestions': {
    'a': '<h1>React makes you sad.</h1> Are you learning React by copying from the boilerplate projects? - Learning React by copying boilerplates is like learning to cook by eating food in fancy restaurants. It doesn’t work. You need to start with basics and ignore the fear of missing out. It’s unfounded. People create boilerplates to show off what they built or learned, not to help you learn. They are created by and for power users, and are often way more experimental than they care to admit. Boilerplates compete for attention which leads to more bloat. If you’re in it for React, learn it in the order Pete Hunt described in his guide: <a href="https://github.com/petehunt/react-howto" target="_blank">https://github.com/petehunt/react-howto</a>. Look at boilerplates no sooner than you can create your own',
    ...
    'c': '<h1>Remove the Flux library</h1> Get a good feel for structuring apps in vanilla React by reading “Thinking in React” in the official docs',
    'd': '<h1>Consider adding a Flux library</h1> It can help externalize the state shared between many components and update it consistently',
    'e': '<h1>Add a bundler</h1> Add a bundler as a build step to keep dependencies manageable and serve the JavaScript code efficiently. Use Google Page Speed insights tool to gauge how well you are doing. Remember to minify and envify your code',
    'f': '<h1>Remove the bundler</h1> There is no need for a bundler if you are just learning React. Copy https://github.com/jarsbe/react-simple and start hacking with no build step. Use <script> tags until you are comfortable with React and want to learn more about module systems and different bundlers',
    ...
    'h': '<h1>Stick to using at most ES2015</h1> JSX, and object spread operator',
    ...
    'j': '<h1>Good call</h1> However we encourage you to try (in a branch!) new versions of React as soon as they come out. Unlike many community packages, they are tested heavily by Facebook. Keep an eye on the release notes as they link to the codemods that automate parts of the migration process for you',
    'k': '<h1>Let us know why!</h1> Write a constructive blog post about the problems you encountered. Refrain from personal attacks. Be polite. Help the community figure out the solutions. Consider another stack that better suites your needs (e.g. Ember)',
